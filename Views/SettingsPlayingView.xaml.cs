...
namespace Check.Views
{
    public partial class SettingsPlayingView
    {
        internal SettingsPlayingView(PositionView positionView)
        {
            ...
            Button   buttonStartPosition    = new Button   { Content = new TextBlock { Text = "To start position"     , VerticalAlignment = VerticalAlignment.Center }, Height = 28d, Margin = new Thickness(4d), ToolTip="To start position <Ctrl+M>"                  } ; buttonStartPosition    .Click += OnStartPosition        ; Grid.SetRow(buttonStartPosition    , 4); Grid.SetColumn(buttonStartPosition    , 0); gridPlaying.Children.Add(buttonStartPosition   );
            Button   buttonSpecialPosition  = new Button   { Content = new TextBlock { Text = "To special position"   , VerticalAlignment = VerticalAlignment.Center }, Height = 28d, Margin = new Thickness(4d), ToolTip="To special position <Ctrl+Shift+M>"          } ; buttonSpecialPosition  .Click += OnSpecialPosition      ; Grid.SetRow(buttonSpecialPosition  , 4); Grid.SetColumn(buttonSpecialPosition  , 1); gridPlaying.Children.Add(buttonSpecialPosition );
